// profiles.h - BT2Nuon Profile Definitions
//
// Button mapping profiles for Bluetooth to Nuon adapter.
...
#ifndef BT2NUON_PROFILES_H
#define BT2NUON_PROFILES_H
