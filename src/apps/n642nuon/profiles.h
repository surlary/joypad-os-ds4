// profiles.h - N642Nuon Profile Definitions
//
// Button mapping profiles for N64 to Nuon adapter.
...
#ifndef N642NUON_PROFILES_H
#define N642NUON_PROFILES_H
...
static const profile_set_t nuon_profile_set = {
    ...
    .default_index = 1,  // Default to N64 profile since input IS an N64 controller
};

#endif // N642NUON_PROFILES_H
